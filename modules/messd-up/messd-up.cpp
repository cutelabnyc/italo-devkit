...
void Module::process() {
  ...
  this->messd.ins.tempo = this->inBuffer[TEMPO];
...
pin_t *Module::getInputPinSchematic() { return inputPinSchematic; };

pin_t *Module::getOutputPinSchematic() { return outputPinSchematic; };
